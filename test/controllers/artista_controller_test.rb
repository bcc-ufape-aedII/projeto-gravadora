...
class ArtistaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artistum" do
    assert_difference("Artistum.count") do
      post artista_url, params: { artistum: { nome_artistico: @artistum.nome_artistico, tipo: @artistum.tipo } }
    end
  ...
  test "should update artistum" do
    patch artistum_url(@artistum), params: { artistum: { nome_artistico: @artistum.nome_artistico, tipo: @artistum.tipo } }
